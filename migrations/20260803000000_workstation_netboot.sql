...
CREATE TABLE boot_profiles_v4 (
    ...
    profile_type TEXT NOT NULL CHECK (profile_type IN ('local_disk', 'james_installer', 'custom_ipxe')),
...
SELECT id, name, description,
       CASE WHEN profile_type = 'linux_installer' AND managed_profile_id IS NOT NULL
            THEN 'james_installer' ELSE profile_type END,
...
CREATE TABLE james_boot_sessions (
...
CREATE INDEX idx_james_boot_sessions_cleanup ON james_boot_sessions(cleanup_after);
